...
/*
* this function reads a file, looks for specific tyes of information, extracts that information in a structured way, and then displays it in an easy to understand format.
 */
func main() {
